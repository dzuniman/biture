...
export default function ProductViewPage({ product, imagePreviewUrl, onBack }: Props) {
  return (
    <div className="page-section">
      <div className="section-header">
        <div>
          <h2>Product Details</h2>
          <p>Viewing product: <strong>{product.code}</strong></p>
        </div>
      ...
      <div className="management-container" style={{ maxWidth: '860px' }}>
        ...
        >
          ...
          >
            {imagePreviewUrl ? (
              <a href={imagePreviewUrl} target="_blank" rel="noopener noreferrer" title="Click to view full image">
                <img
                  src={imagePreviewUrl}
                  alt={product.code}
                  style={{
